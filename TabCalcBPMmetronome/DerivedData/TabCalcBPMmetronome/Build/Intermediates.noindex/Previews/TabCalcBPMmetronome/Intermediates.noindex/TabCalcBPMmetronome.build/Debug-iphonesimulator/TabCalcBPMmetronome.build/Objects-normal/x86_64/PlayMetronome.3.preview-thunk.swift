            ...
            __designTimeSelection(VStack{
                ...
                if self.library.BPMIntCheck(BPM: self.BPMText){
                    ...
                    __designTimeSelection(Button(action: {
                        if self.library.NoteIntCheck(Note: self.Note){ __designTimeSelection(self.audioPlayer.metronome(BPM:__designTimeSelection(self.library.calcQuarterNotes(BPM: __designTimeSelection(self.BPMText, "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[0].[0].[0].modifier[0].arg[0].value.modifier[0].arg[0].value"), Notes: __designTimeSelection(self.Note, "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[0].[0].[0].modifier[0].arg[0].value.modifier[0].arg[1].value")), "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[0].[0].[0].modifier[0].arg[0].value"),PlayCount: __designTimeSelection(self.Count, "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[0].[0].[0].modifier[0].arg[1].value")), "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[0].[0].[0]")
                        }
                        if self.library.NoteIntCheck(Note: self.Note2){ __designTimeSelection(self.audioPlayer.metronome(BPM:__designTimeSelection(self.library.calcQuarterNotes(BPM: __designTimeSelection(self.BPMText, "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[1].[0].[0].modifier[0].arg[0].value.modifier[0].arg[0].value"), Notes: __designTimeSelection(self.Note2, "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[1].[0].[0].modifier[0].arg[0].value.modifier[0].arg[1].value")), "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[1].[0].[0].modifier[0].arg[0].value"),PlayCount: __designTimeSelection(self.Count2, "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[1].[0].[0].modifier[0].arg[1].value")), "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[1].[0].[0]")
                        }
                        if self.library.NoteIntCheck(Note: self.Note3){ __designTimeSelection(self.audioPlayer.metronome(BPM:__designTimeSelection(self.library.calcQuarterNotes(BPM: __designTimeSelection(self.BPMText, "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[2].[0].[0].modifier[0].arg[0].value.modifier[0].arg[0].value"), Notes: __designTimeSelection(self.Note3, "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[2].[0].[0].modifier[0].arg[0].value.modifier[0].arg[1].value")), "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[2].[0].[0].modifier[0].arg[0].value"),PlayCount: __designTimeSelection(self.Count3, "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[2].[0].[0].modifier[0].arg[1].value")), "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[0].value.[2].[0].[0]")
                        }
                    }) {
                        __designTimeSelection(Text(__designTimeString("#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[1].value.[0].arg[0].value.[0].value", fallback: "再生")), "#20642.[2].[15].property.[0].[0].arg[0].value.[1].arg[0].value.[2].[0].[2].arg[1].value.[0]")
