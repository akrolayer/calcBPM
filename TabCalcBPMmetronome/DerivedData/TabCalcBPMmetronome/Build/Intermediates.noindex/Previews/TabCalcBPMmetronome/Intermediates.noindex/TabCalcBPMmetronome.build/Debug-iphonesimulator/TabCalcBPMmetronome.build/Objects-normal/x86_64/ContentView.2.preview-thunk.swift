...
extension ContentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        AnyView(TabView(selection: $selection){
            ...
            Text(__designTimeString("#19904.[1].[1].property.[0].[0].arg[1].value.[1].arg[0].value.[0].value", fallback: "Second View"))
                .font(.title)
                .tabItem {
                    VStack {
                        Image(__designTimeString("#19904.[1].[1].property.[0].[0].arg[1].value.[1].modifier[1].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0].value", fallback: "second"))
                        Text(__designTimeString("#19904.[1].[1].property.[0].[0].arg[1].value.[1].modifier[1].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].value", fallback: "Second"))
                    }
                }
                .tag(__designTimeInteger("#19904.[1].[1].property.[0].[0].arg[1].value.[1].modifier[2].arg[0].value", fallback: 1))
        })
#sourceLocation()
    }
}
