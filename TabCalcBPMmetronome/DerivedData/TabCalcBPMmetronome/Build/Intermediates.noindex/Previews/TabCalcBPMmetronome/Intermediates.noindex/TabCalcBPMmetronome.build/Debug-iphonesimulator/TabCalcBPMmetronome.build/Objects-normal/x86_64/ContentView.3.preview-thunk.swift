...
extension ContentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        AnyView(__designTimeSelection(TabView(selection: __designTimeSelection($selection, "#19904.[1].[1].property.[0].[0].arg[0].value")){
            ...
            __designTimeSelection(PlayMetronome()
                .tabItem {
                    __designTimeSelection(VStack {
                        __designTimeSelection(Image(__designTimeString("#19904.[1].[1].property.[0].[0].arg[1].value.[1].modifier[0].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0].value", fallback: "second")), "#19904.[1].[1].property.[0].[0].arg[1].value.[1].modifier[0].arg[0].value.[0].arg[0].value.[0]")
                        __designTimeSelection(Text(__designTimeString("#19904.[1].[1].property.[0].[0].arg[1].value.[1].modifier[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].value", fallback: "Second")), "#19904.[1].[1].property.[0].[0].arg[1].value.[1].modifier[0].arg[0].value.[0].arg[0].value.[1]")
                    }, "#19904.[1].[1].property.[0].[0].arg[1].value.[1].modifier[0].arg[0].value.[0]")
                }
                .tag(__designTimeInteger("#19904.[1].[1].property.[0].[0].arg[1].value.[1].modifier[1].arg[0].value", fallback: 1)), "#19904.[1].[1].property.[0].[0].arg[1].value.[1]")
