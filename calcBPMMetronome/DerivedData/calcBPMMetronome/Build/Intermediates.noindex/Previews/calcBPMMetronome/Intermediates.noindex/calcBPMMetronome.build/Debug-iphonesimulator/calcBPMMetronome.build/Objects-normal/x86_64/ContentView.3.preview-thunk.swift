...
extension ContentView {
    @_dynamicReplacement(for: calcQuarterNotes(BPM:Notes:)) private func __preview__calcQuarterNotes(BPM: String, Notes: String)-> String {
        ...
        if notes % 12 == 0{
            ...
            return __designTimeSelection(String(__designTimeSelection(bpm, "#9607.[2].[9].[2].[0].[3].arg[0].value")), "#9607.[2].[9].[2].[0].[3]")
        }else{
            while(notes > 4){
                notes /= 2
                bpm *= 2
            }
            return __designTimeSelection(String(__designTimeSelection(bpm, "#9607.[2].[9].[2].[1].[1].arg[0].value")), "#9607.[2].[9].[2].[1].[1]")
        }
#sourceLocation()
    }
}
...
extension ContentView {
    @_dynamicReplacement(for: BPMIntCheck(BPM:)) private func __preview__BPMIntCheck(BPM: String)-> Bool {
        ...
        return (10...1000).contains(__designTimeSelection(bpm, "#9607.[2].[8].[1].modifier[0].arg[0].value"))
#sourceLocation()
    }
}
    ...
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        AnyView(__designTimeSelection(ZStack {
            __designTimeSelection(Color.white.onTapGesture {
                __designTimeSelection(UIApplication.shared.endEditting(), "#9607.[2].[7].property.[0].[0].arg[0].value.[0].modifier[0].arg[0].value.[0]")
            }, "#9607.[2].[7].property.[0].[0].arg[0].value.[0]")
            
            __designTimeSelection(VStack{
                __designTimeSelection(Text(__designTimeString("#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[0].arg[0].value.[0].value", fallback: "BPM変換ツール"))
                    .font(.largeTitle), "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[0]")
                __designTimeSelection(Text(__designTimeString("#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[1].arg[0].value.[0].value", fallback: "4分音符に換算したときのBPMを計算します"))
                    .font(.title), "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[1]")
                __designTimeSelection(TextField(__designTimeString("#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[2].arg[0].value.[0].value", fallback: "BPMを入力してください"), text:__designTimeSelection($BPM, "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[2].arg[1].value"))
                    .textFieldStyle(__designTimeSelection(RoundedBorderTextFieldStyle(), "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[2].modifier[0].arg[0].value"))
                    .keyboardType(.numberPad)
                    .frame(width: __designTimeInteger("#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[2].modifier[2].arg[0].value", fallback: 250)), "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[2]")
                if BPMIntCheck(BPM: BPM){
                    __designTimeSelection(Picker(selection: __designTimeSelection($Note, "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[0].[0].arg[0].value"), label: __designTimeSelection(Text(__designTimeString("#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[0].[0].arg[1].value.arg[0].value.[0].value", fallback: "何分音符ですか？")), "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[0].[0].arg[1].value")) {
                        __designTimeSelection(ForEach(0..<NotesList.count){
                                __designTimeSelection(Text(__designTimeSelection(self.NotesList[__designTimeSelection($0, "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[0].[0].arg[2].value.[0].arg[1].value.[0].arg[0].value.[0].value")], "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[0].[0].arg[2].value.[0].arg[1].value.[0].arg[0].value")), "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[0].[0].arg[2].value.[0].arg[1].value.[0]")
                        }, "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[0].[0].arg[2].value.[0]")
                    }, "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[0].[0]")
                    ...
                    __designTimeSelection(Text(__designTimeString("#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[1].[0].arg[0].value.[0].value", fallback: "BPMは10〜1000を入力してください"))
                        .foregroundColor(.red)
                        .font(.headline), "#9607.[2].[7].property.[0].[0].arg[0].value.[1].arg[0].value.[3].[1].[0]")
                }
            }, "#9607.[2].[7].property.[0].[0].arg[0].value.[1]")
        }, "#9607.[2].[7].property.[0].[0]"))
#sourceLocation()
    }
}
